...
### From [Shrine's data steward](https://open.med.harvard.edu/vvc/viewvc.cgi/shrine/trunk/code/steward/src/main/scala/net/shrine/steward/db/StewardDatabase.scala?view=markup)
...
//readResolve() for a singleton and another useful toString()
...
```
[Prev](Scala-Pros1.md) [Next](Scala-Pros2.md)